...
public class IOUtils {
    ...
    private final static int IO_BUFFER_SIZE = 4096;
    ...
    public static Reader getBufferedReader(InputStream in) {
        return in == null ? null : new BufferedReader(new InputStreamReader(in, CHARSET));
    }
    ...
    public static Writer getBufferedWriter(OutputStream out) {
        return out == null ? null : new BufferedWriter(new OutputStreamWriter(out, CHARSET));
    }
